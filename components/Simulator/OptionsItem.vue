<template>
    <tr class="hover:bg-blue-50">
        <td class="p-4 text-xs text-gray-600 whitespace-nowrap">
            <UInput v-model="editedOption.name" class="w-full" required />
        </td>
        <td class="p-4 text-xs text-gray-600 whitespace-nowrap">
            <DatePicker v-model="editedOption.date" class="w-full" required />
        </td>
        <td class="p-4 text-xs text-gray-600 whitespace-nowrap">
            <UInput v-model.number="editedOption.nb_options" class="w-full" type="number" min="0" required
                @update:model-value="updateAliveOptions" />
        </td>
        <td class="p-4 text-xs text-gray-600 whitespace-nowrap">
            <UInput v-model.number="editedOption.strike" class="w-full" type="number" step="0.01" min="0" required />
        </td>
        <td class="p-4 text-xs text-gray-600 whitespace-nowrap">
            <UInput v-model.number="editedOption.nb_dead_options" class="w-full" type="number" min="0" required
                @update:model-value="updateAliveOptions" />
        </td>
        <td class="p-4 text-xs text-gray-600 whitespace-nowrap">
