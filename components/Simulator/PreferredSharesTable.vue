    ...
    <UCard variant="outline">
        <template #header>
            <div class="flex items-center">
                <span class="text-lg font-semibold">Historique - Les émissions d'actions de préférence</span>
                <UTooltip arrow
                    ...
                    <UButton icon="material-symbols-light:info-outline-rounded" color="neutral" variant="ghost"
                        class="ml-2" size="xs" aria-label="Info" />
                </UTooltip>
            </div>
        </template>
